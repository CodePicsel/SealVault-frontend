    ...
    return (
        <div className="relative group w-full flex justify-center">
            ...
            <button
                ...
                className="w-full max-w-[320px] flex items-center justify-center gap-3 px-6 py-2.5 bg-white/40 hover:bg-white/70 backdrop-blur-md rounded-xl border border-white/80 shadow-sm transition-all duration-300 text-teal-950 font-semibold tracking-wide hover:shadow-[0_4px_20px_-2px_rgba(45,212,191,0.3)]"
            >
